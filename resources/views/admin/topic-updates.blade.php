...
@section('content')
    ...
    <div class="topic-header p-4 mb-4">
        <div class="row align-items-center">
            <div class="col-md-2">
                <img src="{{ $hotTopic->image_url }}" alt="Topic" class="img-fluid rounded" style="border: 3px solid white;">
            </div>
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="mt-3">
                                    ...
                                    <form
                                        ...
                                        method="POST" class="d-inline" onsubmit="return confirm('Delete this update?')">
                                        @csrf
                                        @method('DELETE')
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('hot-topics.topic-updates.update', [$hotTopic->id, $update->id]) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control"
                                            value="{{ old('title', $update->title) }}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Update Content *</label>
                                        <textarea name="content" class="form-control" rows="6" required>{{ old('content', $update->content) }}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if ($update->image_url)
                                            <div class="mt-3">
                                                <img src="{{ $update->image_url }}" class="img-fluid rounded">
                                            </div>
                                        @endif
                                    </div>
    ...
    <div class="modal fade" id="addUpdateModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('hot-topics.topic-updates.store', $hotTopic->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            <label class="form-label">Update Title *</label>
                            <input type="text" name="title" class="form-control"
                                placeholder="e.g., Update – Latest Developments" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Update Content *</label>
                            <textarea name="content" class="form-control" rows="6" placeholder="Enter detailed update content..."
                                required></textarea>
                        </div>
