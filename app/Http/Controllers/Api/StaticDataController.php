...
class StaticDataController extends Controller
{
    ...
    {
        $description = <<<TEXT
खुशखबरी! 'इस्लामिक स्कॉलर' फीचर जल्द ही आ रहा है

अस्सलामु अलैकुम व रहमतुल्लाहि व बरकातुह,

हमें आपको यह बताते हुए बेहद खुशी हो रही है कि अल सिदरा ऐप में 'इस्लामिक स्कॉलर' नाम का एक नया और शानदार फीचर जुड़ने जा रहा है। यह फीचर अभी तैयारी के दौर में है (Coming Soon) और जल्द ही आपकी खिदमत में हाज़िर होगा!

जब यह फीचर लाइव हो जाएगा, तो इसके ज़रिए अपने दीनी प्रोग्रामों (जैसे जलसा, उर्स, शादी या दीगर तकरीबात) के लिए अपनी पसंद के खतीब, शायर, नात-ख़्वां, निज़ामत करने वाले हज़रात या क़ारी साहबान की तारीख लेना बेहद आसान हो जाएगा।

इस फीचर में आपको क्या-क्या सहूलतें मिलेंगी?

तलाश और इंतख़ाब (Search & Select):
अल सिदरा ऐप में 'इस्लामिक स्कॉलर' ऑप्शन पर जाने के बाद एक सर्च बार खुलेगा। आप चाहें तो अपने पसंदीदा आलिम का नाम लिखकर तलाश करें, या नीचे दी गई फेहरिस्त (लिस्ट) में से उनका इंतख़ाब करें।

कैलेंडर और तारीख (Calendar & Date):
आलिम साहब को सेलेक्ट करते ही उनका अगले 6 महीनों का मुकम्मल कैलेंडर आपके सामने खुल जाएगा। इसमें आप देख सकेंगे कि वो कब दस्तयाब (Available) हैं और अपनी सहूलत के मुताबिक़ कोई भी खाली तारीख चुन सकेंगे।

तफ़्सीलात और फॉर्म (Details & Form):
तारीख चुनने के बाद एक फॉर्म भरना होगा। इसमें अपने प्रोग्राम की मुकम्मल तफ़्सील और अपनी नज़दीकी मस्जिद का हवाला (Reference) देकर फॉर्म उन हज़रत को भेज सकेंगे।

दरख्वास्त की मंज़ूरी (Approval):
मौलाना या आलिम साहब आपकी दरख्वास्त और तफ़्सीलात को देखेंगे और अपनी सहूलत के मुताबिक़ उसे मंज़ूर (Accept) या नामंज़ूर (Reject) करेंगे।

महफूज़ अदायगी (Secure Payment):
दरख्वास्त मंज़ूर होने पर आपको अल सिदरा की तरफ से एक पैगाम मिलेगा कि आपकी तारीख तय हो गई है। इसके बाद आपको उन हज़रत के सफर का खर्च ऐप के ज़रिए अदा करना होगा।

अल सिदरा का एतमाद (भरोसा):
आपकी अदा की गई रकम प्रोग्राम मुकम्मल होने तक 'अल सिदरा' ऐप के पास महफूज़ रहेगी। जब आपका प्रोग्राम कामयाबी के साथ पूरा हो जाएगा, तभी यह रकम उन हज़रत को अदा की जाएगी।

इस शानदार फीचर का इंतज़ार करें। अल सिदरा के साथ जुड़ें और अपने दीनी प्रोग्रामों को बिना किसी परेशानी के, आसानी और भरोसे के साथ मुकम्मल करें!
...
TEXT;
    ...
    {
        $description = <<<TEXT
खुशखबरी! "रूहानी इलाज" फ़ीचर जल्द ही आ रहा है।

अस्सलामु अलैकुम व रहमतुल्लाहि व बरकातुह,

अल सिदरा टीम रात-दिन आपकी खिदमत में लगी हुई है। हमें आपको यह बताते हुए बेहद खुशी हो रही है कि हम ऐप में एक बहुत ही ख़ास और अहम फ़ीचर "रूहानी इलाज" जोड़ने जा रहे हैं।

इस फ़ीचर में आपको क्या-क्या सहूलतें मिलेंगी:

परेशानी का इंतख़ाब (Selection):
आप अपनी रूहानी परेशानी को ऐप में सर्च कर सकेंगे या लिस्ट में से चुन सकेंगे।

माहिर आमिलों की तलाश:
जैसे ही आप अपनी परेशानी चुनकर 'Search for Aamil' पर टैप करेंगे, आपके सामने उन माहिर आमिलों की लिस्ट आ जाएगी।

सीधा राब्ता:
आप अपनी पसंद के आमिल साहब से सीधा संपर्क कर सकेंगे और अपना मसला शेयर कर सकेंगे।

सबसे अहम बात:
यह पूरी प्रोसेस बिल्कुल मुफ़्त होगी।

अगर आप चाहें तो ऐप की तरक्की के लिए हदिया दे सकते हैं, लेकिन यह पूरी तरह आपकी मर्ज़ी होगी।
