...
Route::get('islamic-scholar', [StaticDataController::class, 'islamicScholar']);
Route::get('Roohani-ilaj', [StaticDataController::class, 'roohianiIlaj']);
Route::get('Khidmat-e-Deen', [StaticDataController::class, 'khidmatDeen']);
...
Route::get('send-test-notification', function (Request $request, \App\Services\FirebaseNotificationService $firebase) {
    ...
    $firebase->sendToUser($user, 'Hello!', 'This is a' .$type.'notification from Al Sidra.', ['type' => $type]);
